...
public class EditView extends javax.swing.JFrame {
    ...
    public EditView(User admin, User userEdit) {
        initComponents();
        this.admin =admin;
        ...
        txtPhone.setText(userEdit.getPhone());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        boolean check = editUser(userEdit);
        if(check == true){
            JOptionPane.showMessageDialog(this, "successfully edit account!");
            this.dispose();
            new ManageUserView(admin).setVisible(true);
        }else{
